# Ubiquitous Language: Chapter 01: Basic Concepts Of Marketing

Source note: `chapter-01-basic-concepts-of-marketing.md`
Course: Marketing
...
| Term | Definition | Aliases to avoid |
|---|---|---|
| **Exchange** | A voluntary transfer of value between parties. | sale only |
| **4Ps** | Product, price, place, and promotion, the classic controllable marketing mix. | strategy itself |
| **Customer Acquisition** | The process of gaining new customers. | retention |
| **Switching Barrier** | A cost, inconvenience, habit, contract, or relationship factor that makes changing providers harder. | loyalty |
| **Customer Lifetime Value** | The present value of expected future contribution from a customer relationship. | one transaction profit |
