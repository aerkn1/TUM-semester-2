# Ubiquitous Language: Chapter 02: Branding

Source note: `chapter-02-branding.md`
Course: Marketing
...
| Term | Definition | Aliases to avoid |
|---|---|---|
| **Brand Equity** | The incremental value a brand adds to a product or firm beyond functional attributes. | customer equity |
| **Brand Awareness** | The extent to which consumers recognize or recall a brand. | brand liking |
| **Brand Association** | A memory link connecting a brand with attributes, benefits, emotions, or usage situations. | positioning only |
| **Brand Image** | The consumer overall perception of a brand based on associations. | logo |
| **Brand Identity** | The intended set of brand meanings the firm wants to project. | brand image |
| **Brand Loyalty** | A customer tendency to repurchase or prefer a brand over alternatives. | awareness |
