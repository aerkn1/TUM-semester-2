...
Wiki note: `marketing/wiki/chapter-03-product.md`
...
```mermaid
flowchart TD
    Product[Product policy] --> ProductLevels[Product levels]
    ProductLevels --> Core[Core benefit]
    ProductLevels --> Generic[Generic product]
    ProductLevels --> Expected[Expected product]
    ProductLevels --> Augmented[Augmented product]
    ProductLevels --> Potential[Potential product]

    Product --> Digitalization[Product digitalization]
    Digitalization --> Transform[Physical to digital]
    Digitalization --> Augment[Physical plus digital elements]

    Product --> Packaging[Packaging]
    Packaging --> Protection[Protection/logistics]
    Packaging --> Branding[Branding/communication]
    Packaging --> Usage[Usage and augmentation]
    Packaging --> Sustainability[Sustainability]

    Product --> Assortment[Assortment decisions]
    Assortment --> Breadth[Product mix breadth]
    Assortment --> Depth[Product mix depth]
    Product --> Elimination[Product elimination]

    Product --> Recommenders[AI recommender systems]
    ...
    Development --> Stages[Stage-gate process]
    Development --> InnovationSources[Innovation sources]
    InnovationSources --> TechPush[Technology push]
    InnovationSources --> MarketPull[Market pull]
    InnovationSources --> LeadUsers[Lead users]
    InnovationSources --> CoCreation[Customer co-creation]

    Development --> Agile[Agile/lean startup]
    Agile --> Iteration[Test assumptions iteratively]
    Agile --> Feedback[Customer feedback]

    Product --> Research[Preference measurement]
    Research --> Conjoint[Conjoint analysis]
    Conjoint --> Attributes[Attributes and levels]
    Conjoint --> Utilities[Part-worth utilities]
    Conjoint --> ChoiceBased[Choice-based conjoint]
```
