...
Wiki note: `marketing/wiki/chapter-02-branding.md`
...
```mermaid
flowchart TD
    Brand[Brand] --> Identity[Brand identity: intended meaning]
    Brand --> Image[Brand image: consumer perception]
    Brand --> Product[More than product]
    Product --> Differentiation[Differentiation]
    Product --> Meaning[Associations and meaning]

    Brand --> Benefits[Brand benefits]
    Benefits --> Firm[For firm: loyalty, price premium, entry barriers]
    Benefits --> Intermediary[For intermediaries: lower risk, image transfer]
    Benefits --> Consumer[For consumers: orientation, risk reduction, self-expression]

    Brand --> Knowledge[Brand knowledge]
    Knowledge --> Awareness[Brand awareness]
    Awareness --> Recall[Recall]
    Awareness --> Recognition[Recognition]
    Knowledge --> BrandImage[Brand image]
    BrandImage --> Strength[Strength]
    BrandImage --> Favorability[Favorability]
    BrandImage --> Uniqueness[Uniqueness]

    Brand --> Positioning[Brand positioning]
    Positioning --> POP[Points of parity]
    Positioning --> POD[Points of difference]
    Positioning --> Mantra[Brand mantra]

    Brand --> CBBE[CBBE pyramid]
    ...
    Judgments --> Resonance[Resonance]
    Feelings --> Resonance

    Brand --> Elements[Brand elements]
    Elements --> Build[Memorable, meaningful, likable]
    Elements --> Defend[Transferable, adaptable, protectable]

    Brand --> Architecture[Brand architecture]
    Architecture --> LineExtension[Line extension]
    Architecture --> BrandExtension[Brand extension]
    Architecture --> Multibranding[Multi-branding]
    Architecture --> NewBrand[New brands and lines]

    Brand --> Leverage[Brand leverage]
    Leverage --> Alliances[Brand alliances]
    Leverage --> Licensing[Licensing]
    Leverage --> Endorsement[Celebrity endorsement]
    Leverage --> Piracy[Trademark piracy risk]
```
