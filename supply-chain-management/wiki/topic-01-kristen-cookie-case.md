...
Wiki note: `supply-chain-management/wiki/topic-01-kristen-cookie-case.md`
...
- `topic-02-forecasting.md`: demand uncertainty and digital forecasting can improve order planning.
- `topic-03-newsvendor-model.md`: ordering under uncertain demand uses forecast distribution and cost tradeoffs.
