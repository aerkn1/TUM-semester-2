...
Wiki note: `supply-chain-management/wiki/topic-03-newsvendor-model.md`
...
- `topic-02-forecasting.md`: provides the demand distribution and uncertainty that Newsvendor uses.
