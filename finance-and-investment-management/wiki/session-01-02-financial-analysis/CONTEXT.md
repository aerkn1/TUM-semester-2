...
| Term | Definition | Aliases to avoid |
|---|---|---|
| **Balance Sheet** | A statement of assets, liabilities, and equity at a point in time. | income statement |
| **Income Statement** | A statement of revenues, expenses, and profit over a period. | balance sheet |
| **Cash Flow Statement** | A statement explaining cash inflows and outflows from operating, investing, and financing activities. | profit statement |
| **Liquidity Ratio** | A ratio measuring ability to meet short-term obligations. | profitability |
| **Leverage Ratio** | A ratio measuring debt burden or financial risk. | liquidity |
| **Profitability Ratio** | A ratio measuring earnings relative to sales, assets, or equity. | cash flow |
