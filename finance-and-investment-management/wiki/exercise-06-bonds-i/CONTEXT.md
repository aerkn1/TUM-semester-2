# Ubiquitous Language: Exercise 06: Bonds I
...
| **Yield to Maturity** | The discount rate that equates a bond price to the present value of promised cash flows. | coupon rate |
| **Zero-Coupon Bond** | A bond with no coupon payments, sold at a discount and repaid at face value. | coupon bond |
| **Duration** | A weighted average timing measure of bond cash flows and an approximation of price sensitivity to yield changes. | maturity |
