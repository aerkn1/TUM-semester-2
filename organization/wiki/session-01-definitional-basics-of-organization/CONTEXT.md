# Ubiquitous Language: Session 01: Definitional Basics Of Organization

Source note: `session-01-definitional-basics-of-organization.md`
Course: Organization
...
| Term | Definition | Aliases to avoid |
|---|---|---|
| **Formal Organization** | A deliberately designed system of roles, rules, and authority for coordinated action. | any group |
| **Organizing** | The process of dividing, coordinating, and controlling work to achieve goals. | planning only |
| **Organizational Goal** | A desired future state that guides coordinated action. | individual wish |
| **Authority** | The legitimate right to make decisions or give directives. | power only |
