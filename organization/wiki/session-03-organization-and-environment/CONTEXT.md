# Ubiquitous Language: Session 03: Organization And Environment

Source note: `session-03-organization-and-environment.md`
Course: Organization
...
| Term | Definition | Aliases to avoid |
|---|---|---|
| **Task Environment** | The external actors and forces directly affecting the organization operations. | general environment |
| **Global Environment** | Broad economic, technological, political, legal, social, and ecological conditions surrounding organizations. | task environment |
| **Environmental Uncertainty** | The difficulty of predicting external changes because of complexity and dynamism. | risk only |
| **Resource Dependence** | The theory that organizations adapt and build relationships to manage dependence on external resources. | resource scarcity only |
| **Population Ecology** | A theory explaining organizational survival and failure through selection pressures at the population level. | environmentalism |
| **Buffering** | Protecting the technical core from environmental disturbances. | ignoring environment |
