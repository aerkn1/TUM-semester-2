...
Wiki note: `organization/wiki/session-04-strategic-organization-design/session-04-strategic-organization-design.md`
...
```mermaid
flowchart TD
    Strategy[Strategy] --> Characteristics[Guiding concept + capabilities + advantage + risk]
    Strategy --> Structure[Structure relationship]
    Structure --> Follows[Structure follows strategy]
    Structure --> Shapes[Strategy follows structure]
    Strategy --> Intent[Strategic intent]
    ...
    Ambidexterity --> Exploit[Exploitation]
    Ambidexterity --> Explore[Exploration]
    Ambidexterity --> Structural[Structural ambidexterity]
    Ambidexterity --> Contextual[Contextual ambidexterity]

    Tensions --> Diversification[Diversification]
    Diversification --> Growth[Growth]
    Diversification --> Risk[Risk spreading]
    Diversification --> Value[Value creation]
    Diversification --> Porter[Porter's tests]
    Porter --> Attractive[Attractiveness]
    Porter --> Entry[Cost of entry]
    Porter --> BetterOff[Better-off synergy]
    ...
    Responsibility --> Ethics[Ethics beyond legality]

    Strategy --> Practice[Strategy as practice]
    Practice --> Strategizing[Strategizing]
    Strategizing --> Interpretation[Interpretation]
    Strategizing --> Adaptation[Adaptation]
    Strategizing --> Emergence[Emergent strategy]
```
