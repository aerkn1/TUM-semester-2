# Ubiquitous Language: Session 04: Strategic Organization Design

Source note: `session-04-strategic-organization-design.md`
Course: Organization
...
| Term | Definition | Aliases to avoid |
|---|---|---|
| **Strategy** | A pattern of choices about goals, scope, and competitive approach. | plan document only |
| **Structure Follows Strategy** | The principle that organizational design should support strategic priorities. | strategy follows org chart |
| **Differentiation Strategy** | Competing through uniqueness valued by customers. | being different in any way |
| **Cost Leadership** | Competing by achieving lower costs than rivals. | low price only |
| **Ambidexterity** | The capability to exploit existing strengths while exploring new opportunities. | doing everything |
| **Strategic Fit** | Alignment among strategy, structure, environment, and processes. | consistency only |
