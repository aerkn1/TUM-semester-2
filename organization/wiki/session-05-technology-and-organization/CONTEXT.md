# Ubiquitous Language: Session 05: Technology And Organization

Source note: `session-05-technology-and-organization.md`
Course: Organization
...
| Term | Definition | Aliases to avoid |
|---|---|---|
| **Technology** | The knowledge, tools, and processes used to transform inputs into outputs. | digital tools only |
| **Task Uncertainty** | The unpredictability and analyzability of work tasks. | environmental uncertainty |
| **Routine Technology** | Technology with predictable tasks and analyzable procedures. | boring work |
| **Nonroutine Technology** | Technology involving ambiguous problems and low analyzability. | creative work only |
| **Technical Core** | The part of the organization directly responsible for producing goods or services. | IT system |
| **Interdependence** | The degree to which tasks or units rely on each other to complete work. | teamwork |
