...
Wiki note: `organization/wiki/session-05-technology-and-organization/session-05-technology-and-organization.md`
...
```mermaid
flowchart TD
    Tech[Technology in organizations] --> Definition[Tools, methods, procedures, skills]
    Definition --> Transformation[Inputs -> transformation -> outputs]
    Tech --> Levels[Levels of analysis]
    Levels --> Task[Task]
    Levels --> Department[Department]
    Levels --> Organization[Organization]
    Levels --> Society[Society]

    Tech --> Modernist[Modernist typologies]
    ...
    Woodward --> Fit[Technology-structure fit]
    Thompson --> LongLinked[Long-linked]
    Thompson --> Mediating[Mediating]
    Thompson --> Intensive[Intensive]
    Perrow --> Routine[Routine]
    Perrow --> Engineering[Engineering]
    Perrow --> Craft[Craft]
    Perrow --> Nonroutine[Nonroutine]

    Tech --> Symbolic[Symbolic-interpretive view]
    ...
    AST --> UseShapes[Users shape technology-in-use]

    Tech --> Toolkit[Practice toolkit]
    Toolkit --> Affordances[Affordances]
    Toolkit --> Constraints[Constraints]
    Toolkit --> Frames[Technological frames]
    Toolkit --> Enactment[Enactment]

    Tech --> Control[Technology and control]
    Control --> Surveillance[Surveillance]
