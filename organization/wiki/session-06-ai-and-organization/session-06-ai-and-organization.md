...
Wiki note: `organization/wiki/session-06-ai-and-organization/session-06-ai-and-organization.md`
...
```mermaid
flowchart TD
    AI[AI in organizations] --> Definition[Cognitive functions: learning/interacting/problem solving]
    AI --> NoDet[No technological determinism]
    NoDet --> Practice[Effects depend on organizational practice]

    AI --> Domains[Four effect domains]
    Domains --> Task[Task division]
    Domains --> Roles[Roles/knowledge/expertise]
    Domains --> Stability[Stability/change]
    Domains --> Ethics[Fairness/ethics/accountability]

    Task --> Automation[Automation]
    Task --> Augmentation[Augmentation]
    Automation --> Paradox[Automation-augmentation paradox]
    Augmentation --> Paradox
    Task --> Centaur[Centaur]
    Task --> Cyborg[Cyborg]

    Roles --> HumanAssist[Humans assist machines]
    HumanAssist --> Training[Training]
    HumanAssist --> Explaining[Explaining]
    HumanAssist --> Sustaining[Sustaining]
    Roles --> MachineAssist[Machines assist humans]
    MachineAssist --> Amplifying[Amplifying]
    MachineAssist --> Interacting[Interacting]
    MachineAssist --> Embodying[Embodying]
    Roles --> Expertise[Expertise growth or erosion]

    Stability --> Change[Change mechanisms]
    Change --> Capacitating[Capacitating]
    Change --> Reframing[Reframing]
    Stability --> Inertia[Stability mechanisms]
    Inertia --> Shielding[Shielding]
    Inertia --> Adhering[Adhering]
    Inertia --> Sedimentation[Sedimented assumptions]

    Ethics --> Bias[Bias]
    Ethics --> Privacy[Privacy]
    Ethics --> Transparency[Transparency]
    Ethics --> Accountability[Accountability]
    Ethics --> AlgControl[Algorithmic control]

    AI --> Aurelia[Aurelia NOVA case]
    Aurelia --> WorkAllocation[Work allocation charter]
    Aurelia --> ExpertiseConcept[Expertise development concept]
    Aurelia --> AdaptiveUse[Adaptive AI use concept]
    Aurelia --> Governance[Responsible AI governance]
```
