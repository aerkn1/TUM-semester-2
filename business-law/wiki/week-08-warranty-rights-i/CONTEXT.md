...
```mermaid
flowchart TD
    Start[Defective purchase facts] --> Contract[Section 433 purchase agreement]
    Contract --> Defect{Defect at transfer of risk?}
    Defect -->|Material| S434[Section 434 BGB]
    Defect -->|Legal| S435[Section 435 BGB]
    Defect -->|No| NoWarranty[No warranty remedies]
    S434 --> Exclusions{Any exclusion?}
    S435 --> Exclusions
    Exclusions --> BuyerKnowledge[Section 442 buyer knowledge]
    Exclusions --> HGB377[Section 377 HGB merchant notice]
    Exclusions --> ContractClause[Contractual/SBT exclusion]
    ContractClause --> Limits[Sections 444, 476, 309 No. 8, 242 limits]
    Exclusions --> Remedies[Section 437 gateway]
    Remedies --> Cure[Sections 437 No. 1, 439 cure]
    Cure --> Secondary[Revocation / reduction / damages / reimbursement]
```
