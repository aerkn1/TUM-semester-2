...
```mermaid
flowchart TD
    Start[Warranty defect route cleared] --> S437[Section 437 No. 3]
    S437 --> Classify{Hypothetical-performance test}
    Classify -->|Loss remains| Add[Damages in addition]
    Add --> S280[Section 280 I]
    Classify -->|Loss disappears| InLieu[Damages instead of performance]
    InLieu --> Possible{Performance possible?}
    Possible -->|Yes, period needed| S281[Sections 280 I, III, 281]
    Possible -->|Secondary duty destroys trust| S282[Sections 280 I, III, 282]
    Possible -->|No, subsequent impossibility| S283[Sections 280 I, III, 283]
    Possible -->|Initial impossibility| S311a[Section 311a]
    S437 --> Expenses[Section 284 futile expenses]
    S437 --> Work[Section 634 work-contract comparison]
```
